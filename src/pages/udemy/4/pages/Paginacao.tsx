...
function Paginacao(props: PaginacaoProps) {
  ...
  function gerarItemNumerico(pagina: number) {
    return (
      <Pagination.Item
        key={pagina}
  ...
  function gerarProximoItem(numPaginas: number) {
    return (
      <Pagination.Next
        key="pagNext"
        onClick={() => props.mudarPagina(props.paginaAtual + 1)}
  ...
  function gerarUltimoItem(numPaginas: number) {
    return (
      <Pagination.Last
        key="pagLast"
